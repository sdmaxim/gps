shell = (function () {
	...
	var
		configMap = {
			main_html : String()
				+ '<div class="header">Уменьшение количества точек GPS трекинга. Чем больше угол или масштаб тем больше будет пропущено точек. Синие точки - пропущенные, Красные оставленные.</div>'
				+ '<div id="left"></div>'
				+ '<div id="middle"></div>'
		},
		stateMap = {
